...
class Frame:
    ...
    all_settings = {
        # TODO: Remove PID settings, keep Temperature settings
        "PID: Temperature [\u2103]" : 0xAD5E,
        "PID: Tolerance [\u2103]" : 0x0000, #TODO - probably sending in previous command?
        ...
        "PWM: Frequency [Hz]" : 0xADFF,
        "PWM: Preheat power [%]" : 0xAD03,  # TODO: Change to Max
        "PWM: Main power [%]" : 0xAD01,     # TODO: Change to Initial
    ...
    general_commands = {
        "Identify" : 0x1D1D,        # TODO: Change designation - Make another button or destroy that one? 
        "Read settings" : 0x5EED,   # TODO: Is it necessary? 
